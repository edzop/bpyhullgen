...
new_longitudinal=chine_helper.longitudinal_definition(z_offset=-0.2,width=-0.13,thickness=0.1)
...
new_longitudinal=chine_helper.longitudinal_definition(width=-0.13,thickness=0.1)
new_longitudinal.set_limit_x_length(the_hull.start_bulkhead_location,2)
new_chine.add_longitudinal_definition(new_longitudinal)
